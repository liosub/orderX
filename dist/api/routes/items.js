...
itemsRouter.get('/menu/:menu_id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = Number(req.params.menu_id);
    const result = yield itemsServiceImpl.getAllByMenuId(id);
    return res.status(200).send(result);
}));
itemsRouter.post('/', upload_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
...
itemsRouter.put('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = Number(req.params.id);
    const payload = req.body;
